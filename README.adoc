...
docker run -it --rm --entrypoint=/usr/local/bin/iozone                   ghcr.io/tin6150/satoolbag:rocky8 -a		# automatic test?  see container's install_load_test.sh for better test.
...
2026.0602 trying to add mst tool to container, not sure if it would work in hpc under aptainer
